...
def predict_genres(year, title, plot):
    ...
    movie_data = pd.DataFrame({'year': [year], 'title': [title], 'plot': [preprocessed_plot]})
...
if __name__ == "__main__":
    ...
    if len(sys.argv) < 4:
        ...
        predicted_genres = predict_genres(year, title, plot)
        
        print('Géneros de la película:', predicted_genres)